...
- Demo: https://lab.moumen.dev/components/schedule-builder
- Install: `npx moumenlab add schedule-builder` — or `npx shadcn@latest add https://lab.moumen.dev/r/schedule-builder.json`
- Dependencies: motion
- Registry dependencies: https://lab.moumen.dev/r/lab-theme.json
- Installs to: `components/lab/schedule-builder.tsx`
...
## Source — `components/lab/schedule-builder.tsx`
