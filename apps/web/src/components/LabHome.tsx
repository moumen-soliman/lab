...
import { Kbd, SearchTrigger, useMetaLabel } from "./RegistryPalette";
        ...
        <header className="mb-10 animate-fade-in">
          <div className="mb-8 flex items-center justify-between gap-4">
            ...
            <div className="flex flex-none items-center gap-2">
              {/* Same 40px height as the pill beside it, and the only way into
              ...
              >
                ...
                {/* The label is the pill's whole width; on a narrow phone it
                    goes and the mark speaks for itself. */}
